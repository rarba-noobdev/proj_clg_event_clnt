...
<div class="flex items-center gap-3 md:gap-6">
	<nav class="hidden items-center gap-3 md:flex md:gap-4">
		{#if user}
			<a
				href="/upcoming"
				class="group flex items-center rounded-lg border border-indigo-500/30 bg-indigo-900 px-4 py-1.5 text-sm font-medium text-indigo-400 shadow-sm transition-all duration-200 hover:bg-indigo-800 hover:text-indigo-300 hover:shadow-indigo-500/20 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-950 focus:outline-none"
			>
				<svg
			...
			<a
				href="/courses"
				class="group flex items-center rounded-lg border border-emerald-500/30 bg-emerald-900 px-4 py-1.5 text-sm font-medium text-emerald-400 shadow-sm transition-all duration-200 hover:bg-emerald-800 hover:text-emerald-300 hover:shadow-emerald-500/20 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-gray-950 focus:outline-none"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="mr-2 h-4 w-4 transition-transform duration-200 group-hover:translate-x-0.5"
	...
	<div class="flex items-center gap-2 md:gap-3">
		{#if !user}
			<a
				href="/auth/login"
				class="flex items-center rounded-lg border border-indigo-500/30 bg-indigo-900 px-4 py-1.5 text-sm font-medium text-indigo-400 shadow-sm transition-all duration-200 hover:bg-indigo-800 hover:text-indigo-300 hover:shadow-indigo-500/20 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-950 focus:outline-none"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
		...
		{:else}
			<div
				class="hidden items-center gap-2 rounded-lg border border-indigo-500/20 bg-indigo-900 px-3 py-1.5 sm:flex"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
				...
				<span class="max-w-[120px] truncate text-sm font-medium text-indigo-400">{user.email}</span>
			</div>
			<button
				onclick={logOut}
				class="flex items-center rounded-lg border border-indigo-500/30 bg-indigo-900 px-3 py-1.5 text-sm font-medium text-indigo-400 shadow-sm transition-all duration-200 hover:bg-indigo-800 hover:text-indigo-300 hover:shadow-indigo-500/20 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-950 focus:outline-none"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					class="mr-1 h-4 w-4"
